...
import static br.ailtonbsj.usermanagerdemo.constant.SecurityConstant.*;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(DOMAIN_NAME).withAudience(APPLICATION_NAME)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(DOMAIN_NAME).build();
